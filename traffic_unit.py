...
FILENAME = '/media/katerina/FierceHorse/waymo_motion_dataset/uncompressed/tf_example/training/training_tfexample.tfrecord-00000-of-01000'
FILENAME2 = '/media/katerina/FierceHorse/waymo_motion_dataset/uncompressed/tf_example/training/'
import math
import os
import uuid
import time
...
def predict_traffic():
    ...
    pathlist = sorted(Path(FILENAME2).glob('*'))


    dataset = tf.data.TFRecordDataset(pathlist, compression_type='')
